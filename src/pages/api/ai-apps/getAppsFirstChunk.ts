...
export const getAiAppsFirstChunkFromTable = () =>
  new Promise((resolve, reject) => {
    ...
    table.select({ view: 'Meta, Content, Cover Image', maxRecords: 21 }).eachPage(
      (apps, fetchNextPage) => {
...
const getAiAppsFirstChunk = async (req: NextApiRequest, res: NextApiResponse) => {
  try {
    const records = await getAiAppsFirstChunkFromTable();
...
export default getAiAppsFirstChunk;
